...
(comment
  Explanation
  Reduce accepts two arguments: function f, value v and collection coll.
  ...
  item in coll, then applying f to that result and the 2nd item, etc. If coll contains no items,
